        ...
        <View className="flex-row justify-between items-center mb-4">
          ...
          <View>
            <PriceText
              ...
              classNameValue="text-2xl font-bold text-gray-800 ml-1"
            />
          </View>
        </View>
        <View className="flex-row items-center bg-blue-light p-3 mb-4 rounded-lg">
          <View className="bg-blue-base w-[36px] h-[36px] rounded-[6px] items-center justify-center">
            <Ionicons name="trending-up" size={20} color={colors.white} />
          </View>
          <Text className="text-sm text-gray-600 ml-5 flex-1">
